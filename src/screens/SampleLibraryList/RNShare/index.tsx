...
const RNShare = () => {
  const myCustomShare = async () => {
    const shareOptions: ShareOptions = {
      ...
      // url: files.appLogo, // 'data:image/png;base64,
      // urls: [files.image1, files.image2],
      url: files.samplePdf, // 'data:application/pdf;base64,JVBERi0xLjcNCiXi48/
      filename: 'hello',
    };
    ...
    // const instagramURL = `instagram://library?AssetPath=${encodeURL}`;
