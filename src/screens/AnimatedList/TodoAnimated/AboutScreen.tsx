...
import { DrawerParamType } from '../../../navigation/FoodDelivery';
...
import LinkButton from '../../../components/TodoAnimated/link-button';
  ...
  return (
    <AnimatedColorBox
      ...
      <Masthead
        ...
        // assets/TodoAnimated/about-masthead.png
        image={require('../../../assets/TodoAnimated/about-masthead.png')}>
        <Navbar />
      </Masthead>
      <ScrollView
        ...
        <VStack flex={1} space={4}>
          <Box alignItems="center">
            <Image
              source={require('../../../assets/TodoAnimated/takuya.jpg')}
              borderRadius="full"
              resizeMode="cover"
              w={120}
              h={120}
