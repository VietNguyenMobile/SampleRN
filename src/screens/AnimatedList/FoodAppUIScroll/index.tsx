...
import {
  ...
  menu2Data,
  menu3Data,
} from '../../../assets/AnimationList/data/menuData';
...
type FoodAppUIScrollProps = NativeStackScreenProps<
  AnimatedParamType,
  'FoodAppUIScroll'
>;

const FoodAppUIScroll: FunctionComponent<FoodAppUIScrollProps> = ({
  navigation,
}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        <Image
          source={require('../../../assets/AnimationList/images/food-app/left-arrow.png')}
      ...
      <TouchableOpacity
        ...
        <Animated.Image
          source={require('../../../assets/AnimationList/images/food-app/search.png')}
      ...
      <Animated.View style={[styles.bannerContainer, bannerAnimation]}>
        <Image
          style={styles.banner}
          source={require('../../../assets/AnimationList/images/food-app/foodBanner.png')}
        />
        <LinearGradient
...
export default FoodAppUIScroll;
