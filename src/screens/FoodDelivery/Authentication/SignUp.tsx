...
import { FONTS, SIZES, COLORS, icons } from '../../../constants/FoodDelivery';
import {
  FormInput,
  CustomSwitch,
  TextButton,
...
type SignUpProps = NativeStackScreenProps<MainParamType, 'FoodDelivery_SignUp'>;
  ...
  return (
    <AuthLayout
      ...
      <TextButton
        ...
        onPress={() => navigation.navigate('FoodDelivery_OTP')}
      />
      {/* Footer */}
      <View
        style={{
