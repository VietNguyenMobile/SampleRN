...
type MyCardProps = NativeStackScreenProps<MainParamType, 'FoodDelivery_MyCard'>;
        ...
        <TextButton
          ...
          onPress={() => {
            if (selectedCard?.key === 'NewCard') {
              navigation.navigate('FoodDelivery_AddCard', {
                selectedCard,
              });
            } else {
              navigation.navigate('FoodDelivery_Checkout', { selectedCard });
            }
          }}
        />
      </View>
